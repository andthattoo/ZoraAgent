...
!function () {
  ...
  function p(e, a) {
    ...
    for (var n = 0; n < e.length; ++n) {
      ...
      if ("object" != typeof i)
        return (
          (t.valid = !1),
          (t.error = s + "must be an object, but " + typeof i + " given"),
          t
        );
      if (!P.helper.isString(i.type))
        return (
          (t.valid = !1),
          (t.error =
            s +
      ...
      if (
        "lang" !==
          (o =
            "html" === (o = "language" === o ? (i.type = "lang") : o)
              ? (i.type = "output")
              : o) &&
        "output" !== o &&
        "listener" !== o
      ...
      if ("listener" === o) {
        if (P.helper.isUndefined(i.listeners))
          return (
            (t.valid = !1),
            (t.error =
              s +
        ...
        P.helper.isUndefined(i.filter) &&
        P.helper.isUndefined(i.regex)
      )
        return (
          (t.valid = !1),
          (t.error =
      ...
      if (i.listeners) {
        ...
        for (var l in i.listeners)
          if (
            i.listeners.hasOwnProperty(l) &&
            "function" != typeof i.listeners[l]
          )
            return (
              (t.valid = !1),
              (t.error =
      ...
      if (i.filter) {
        ...
        if (
          (P.helper.isString(i.regex) && (i.regex = new RegExp(i.regex, "g")),
        ...
        if (P.helper.isUndefined(i.replace))
          return (
            (t.valid = !1),
            (t.error =
              s +
  ...
  (P.helper = {}),
    ...
    void 0 === this && "undefined" != typeof window
      ...
      : (void 0 === this.document &&
          void 0 === this.window &&
          ((e = require("jsdom")), (this.window = new e.JSDOM("", {}).window)),
        (P.helper.document = this.window.document)),
    ...
    (P.helper.forEach = function (e, a) {
      ...
      if (P.helper.isUndefined(a))
        throw new Error("callback param is required");
      if (!P.helper.isFunction(a))
        throw new Error("callback param must be a function/closure");
      if ("function" == typeof e.forEach) e.forEach(a);
      else if (P.helper.isArray(e))
        for (var r = 0; r < e.length; r++) a(e[r], r, e);
      else {
        if ("object" != typeof e)
          throw new Error(
        ...
        if (c.test(m[0])) n++ || (i = (s = l.lastIndex) - m[0].length);
          ...
          var h = m.index + m[0].length,
            m = {
              ...
              right: { start: m.index, end: h },
              wholeMatch: { start: i, end: h },
            };
  ...
  function i(o, l, c, u, h) {
    return (
      ...
      function (e, a, r, t, n, s, i) {
        return /\n\n/.test(e)
          ? e
          : b(_(o, l + ".captureStart", e, a, r, t, i, c, u), c, u, h);
      }
    );
  }
  function l(o, l, c, u, h) {
    return function (e, a, r, t, n, s, i) {
      return (
        (t = P.helper.applyBaseUrl(c.relativePathBaseUrl, t)),
        b(_(o, l + ".captureStart", e, a, r, t, i, c, u), c, u, h)
      );
    };
  }
  function _(e, a, r, t, n, s, i, o, l) {
    return l.converter._dispatch(a, r, o, l, {
      regexp: e,
      matches: { wholeMatch: r, text: t, id: n, url: s, title: i },
    });
  }
  function b(e, a, r, t) {
    ...
    if (t) o = "";
      ...
      if (
        ((o = "#" + (i = i || s.toLowerCase().replace(/ ?\n/g, " "))),
        P.helper.isUndefined(r.gUrls[i]))
      )
        return n;
      (o = r.gUrls[i]),
        P.helper.isUndefined(r.gTitles[i]) || (e = r.gTitles[i]);
    }
    (o = o.replace(
      P.helper.regexes.asteriskDashTildeAndColon,
    ...
    t =
      ...
      l +
      ">" +
      (s = P.subParser("makehtml.hashHTMLSpans")(s, a, r)) +
      "</a>";
  ...
  (P.helper.matchRecursiveRegExp = function (e, a, r, t) {
    ...
    (P.helper.replaceRecursiveRegExp = function (e, a, r, t, n) {
      ...
      if (0 < o) {
        ...
        0 !== i[0].wholeMatch.start &&
          l.push(e.slice(0, i[0].wholeMatch.start));
        for (var c = 0; c < o; ++c)
          l.push(
            a(
              e.slice(i[c].wholeMatch.start, i[c].wholeMatch.end),
              e.slice(i[c].match.start, i[c].match.end),
              e.slice(i[c].left.start, i[c].left.end),
              e.slice(i[c].right.start, i[c].right.end)
            )
          ),
            c < o - 1 &&
              l.push(e.slice(i[c].wholeMatch.end, i[c + 1].wholeMatch.start));
        i[o - 1].wholeMatch.end < e.length &&
          l.push(e.slice(i[o - 1].wholeMatch.end)),
          (r = l.join(""));
      }
      return r;
    }),
    ...
    (P.helper.applyBaseUrl = function (e, a) {
      return (a =
        e && !this.isAbsolutePath(a) ? (0, require("url").resolve)(e, a) : a);
    }),
    ...
    P.subParser("makehtml.blockGamut", function (e, a, r) {
      ...
      return (
        (e = r.converter
          ._dispatch("makehtml.blockGamut.before", e, a, r)
          .getText()),
        ...
        (e = r.converter
          ._dispatch("makehtml.blockGamut.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.blockQuotes", function (e, a, r) {
      "use strict";
      e = r.converter
        ._dispatch("makehtml.blockQuotes.before", e, a, r)
        .getText();
      var t = /(^ {0,3}>[ \t]?.+\n(.+\n)*\n*)+/gm;
      return (
        ...
        (e = (e += "\n\n").replace(t, function (e) {
          return (
            ...
            (e = (e = (e = P.subParser("makehtml.blockGamut")(e, a, r)).replace(
              /(^|\n)/g,
              "$1  "
            )).replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function (e, a) {
              return a.replace(/^  /gm, "¨0").replace(/¨0/g, "");
            })),
            P.subParser("makehtml.hashBlock")(
              "<blockquote>\n" + e + "\n</blockquote>",
              a,
              r
            )
        ...
        (e = r.converter
          ._dispatch("makehtml.blockQuotes.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.codeBlocks", function (e, n, s) {
      "use strict";
      e = s.converter
        ._dispatch("makehtml.codeBlocks.before", e, n, s)
        .getText();
      return (
        (e = (e = (e += "¨0").replace(
          /(?:\n\n|^)((?:(?:[ ]{4}|\t).*\n+)+)(\n*[ ]{0,3}[^ \t\n]|(?=¨0))/g,
        ...
        (e = s.converter
          ._dispatch("makehtml.codeBlocks.after", e, n, s)
          .getText())
      );
    }),
    P.subParser("makehtml.codeSpans", function (e, n, s) {
      ...
      return (
        (e = (e =
          void 0 ===
          (e = s.converter
            ._dispatch("makehtml.codeSpans.before", e, n, s)
            .getText())
            ? ""
            : e).replace(
          /(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm,
          function (e, a, r, t) {
            return (
              ...
              (t =
                a +
                "<code>" +
                (t = P.subParser("makehtml.encodeCode")(t, n, s)) +
                "</code>"),
              (t = P.subParser("makehtml.hashHTMLSpans")(t, n, s))
            );
          }
        )),
        (e = s.converter
          ._dispatch("makehtml.codeSpans.after", e, n, s)
          .getText())
      );
    }),
    P.subParser("makehtml.completeHTMLDocument", function (e, a, r) {
      ...
      e = r.converter
        ._dispatch("makehtml.completeHTMLDocument.before", e, a, r)
        .getText();
      var t,
        n = "html",
        s = "<!DOCTYPE HTML>\n",
      ...
      for (t in (void 0 !== r.metadata.parsed.doctype &&
        ...
        ("html" !== (n = r.metadata.parsed.doctype.toString().toLowerCase()) &&
          "html5" !== n) ||
          (o = '<meta charset="utf-8">')),
      r.metadata.parsed))
      ...
      return (
        (e =
          ...
          "\n</body>\n</html>"),
        (e = r.converter
          ._dispatch("makehtml.completeHTMLDocument.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.detab", function (e, a, r) {
      "use strict";
      return (
        (e = (e = (e = (e = (e = (e = r.converter
          ._dispatch("makehtml.detab.before", e, a, r)
          .getText()).replace(/\t(?=\t)/g, "    ")).replace(
          /\t/g,
          "¨A¨B"
        )).replace(/¨B(.+?)¨A/g, function (e, a) {
    ...
    P.subParser("makehtml.ellipsis", function (e, a, r) {
      ...
      return a.ellipsis
        ? ((e = (e = r.converter
            ._dispatch("makehtml.ellipsis.before", e, a, r)
            .getText()).replace(/\.\.\./g, "…")),
          r.converter._dispatch("makehtml.ellipsis.after", e, a, r).getText())
        : e;
    }),
    P.subParser("makehtml.emoji", function (e, a, r) {
      ...
      return (
        (e = (e = r.converter
          ._dispatch("makehtml.emoji.before", e, a, r)
          .getText()).replace(/:([\S]+?):/g, function (e, a) {
    ...
    P.subParser("makehtml.encodeAmpsAndAngles", function (e, a, r) {
      "use strict";
      return (
        (e = (e = (e = (e = (e = r.converter
          ._dispatch("makehtml.encodeAmpsAndAngles.before", e, a, r)
          .getText()).replace(
          /&(?!#?[xX]?(?:[0-9a-fA-F]+|\w+);)/g,
          "&amp;"
        ...
        (e = r.converter
          ._dispatch("makehtml.encodeAmpsAndAngles.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.encodeBackslashEscapes", function (e, a, r) {
      ...
      return (
        (e = (e = (e = r.converter
          ._dispatch("makehtml.encodeBackslashEscapes.before", e, a, r)
          .getText()).replace(
          /\\(\\)/g,
          P.helper.escapeCharactersCallback
        )).replace(
        ...
        (e = r.converter
          ._dispatch("makehtml.encodeBackslashEscapes.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.encodeCode", function (e, a, r) {
      ...
      return (
        (e = (e = r.converter
          ._dispatch("makehtml.encodeCode.before", e, a, r)
          .getText())
          .replace(/&/g, "&amp;")
          .replace(/</g, "&lt;")
          .replace(/>/g, "&gt;")
        ...
        (e = r.converter
          ._dispatch("makehtml.encodeCode.after", e, a, r)
          .getText())
      );
    }),
    P.subParser(
    ...
    P.subParser("makehtml.githubCodeBlocks", function (e, s, i) {
      ...
      return s.ghCodeBlocks
        ? ((e = i.converter
            ._dispatch("makehtml.githubCodeBlocks.before", e, s, i)
            .getText()),
          (e = (e = (e += "¨0").replace(
            /(?:^|\n) {0,3}(```+|~~~+) *([^\n\t`~]*)\n([\s\S]*?)\n {0,3}\1/g,
            function (e, a, r, t) {
              ...
              return (
                ...
                (t =
                  ...
                  ">" +
                  (t = (t = (t = P.subParser("makehtml.detab")(
                    t,
                    s,
                    i
                  )).replace(/^\n+/g, "")).replace(/\n+$/g, "")) +
                ...
                "\n\n¨G" +
                  (i.ghCodeBlocks.push({ text: e, codeblock: t }) - 1) +
                  "G\n\n"
              );
            }
          )).replace(/¨0/, "")),
          i.converter
            ._dispatch("makehtml.githubCodeBlocks.after", e, s, i)
            .getText())
        : e;
    }),
    P.subParser("makehtml.hashBlock", function (e, a, r) {
      ...
      return (
        (e = (e = r.converter
          ._dispatch("makehtml.hashBlock.before", e, a, r)
          .getText()).replace(/(^\n+|\n+$)/g, "")),
        (e = "\n\n¨K" + (r.gHtmlBlocks.push(e) - 1) + "K\n\n"),
        (e = r.converter
          ._dispatch("makehtml.hashBlock.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.hashCodeTags", function (e, n, s) {
      "use strict";
      e = s.converter
        ._dispatch("makehtml.hashCodeTags.before", e, n, s)
        .getText();
      return (
        ...
        (e = s.converter
          ._dispatch("makehtml.hashCodeTags.after", e, n, s)
          .getText())
      );
    }),
    ...
    P.subParser("makehtml.hashHTMLBlocks", function (e, a, n) {
      "use strict";
      e = n.converter
        ._dispatch("makehtml.hashHTMLBlocks.before", e, a, n)
        .getText();
      function r(e, a, r, t) {
        return (
          -1 !== r.search(/\bmarkdown\b/) &&
            (e = r + n.converter.makeHtml(a) + t),
      ...
      for (var s = 0; s < t.length; ++s)
        for (
          var i = new RegExp("^ {0,3}(<" + t[s] + "\\b[^>]*>)", "im"),
            o = "<" + t[s] + "\\b[^>]*>",
            l = "</" + t[s] + ">";
          -1 !== (c = P.helper.regexIndexOf(e, i));
      ...
      return (
        (e = e.replace(
          /(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,
          P.subParser("makehtml.hashElement")(e, a, n)
        )),
        ...
        (e = n.converter
          ._dispatch("makehtml.hashHTMLBlocks.after", e, a, n)
          .getText())
      );
    }),
    P.subParser("makehtml.hashHTMLSpans", function (e, a, r) {
      ...
      return (
        (e = (e = (e = (e = (e = r.converter
          ._dispatch("makehtml.hashHTMLSpans.before", e, a, r)
        ...
        (e = r.converter
          ._dispatch("makehtml.hashHTMLSpans.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.unhashHTMLSpans", function (e, a, r) {
      "use strict";
      e = r.converter
        ._dispatch("makehtml.unhashHTMLSpans.before", e, a, r)
        .getText();
      ...
      return (e = r.converter
        ._dispatch("makehtml.unhashHTMLSpans.after", e, a, r)
        .getText());
    }),
    P.subParser("makehtml.hashPreCodeTags", function (e, n, s) {
      "use strict";
      e = s.converter
        ._dispatch("makehtml.hashPreCodeTags.before", e, n, s)
        .getText();
      return (
        (e = P.helper.replaceRecursiveRegExp(
          e,
          function (e, a, r, t) {
            ...
            return (
              "\n\n¨G" +
              (s.ghCodeBlocks.push({ text: e, codeblock: r }) - 1) +
              "G\n\n"
            );
          },
          "^ {0,3}<pre\\b[^>]*>\\s*<code\\b[^>]*>",
        ...
        (e = s.converter
          ._dispatch("makehtml.hashPreCodeTags.after", e, n, s)
          .getText())
      );
    }),
    P.subParser("makehtml.headers", function (e, n, s) {
      ...
      function o(e) {
        var a = (e =
            n.customizedHeaderId && (a = e.match(/{([^{]+?)}\s*$/)) && a[1]
              ? a[1]
              : e),
          e = P.helper.isString(n.prefixHeaderId)
            ? n.prefixHeaderId
            : !0 === n.prefixHeaderId
            ? "section-"
            : "";
        return (
          ...
          n.rawPrefixHeaderId && (a = e + a),
          s.hashLinkCounts[a]
            ? (a = a + "-" + s.hashLinkCounts[a]++)
            : (s.hashLinkCounts[a] = 1),
          a
        );
      }
      return (
        (e = e.replace(a, function (e, a, r) {
          var t = r,
            t =
              (n.customizedHeaderId && (t = r.replace(/\s?{([^{]+?)}\s*$/, "")),
              P.subParser("makehtml.spanGamut")(t, n, s)),
    ...
    P.subParser("makehtml.horizontalRule", function (e, a, r) {
      "use strict";
      e = r.converter
        ._dispatch("makehtml.horizontalRule.before", e, a, r)
        .getText();
      var t = P.subParser("makehtml.hashBlock")("<hr />", a, r);
      return (
        (e = (e = (e = e.replace(/^ {0,2}( ?-){3,}[ \t]*$/gm, t)).replace(
          /^ {0,2}( ?\*){3,}[ \t]*$/gm,
          t
        )).replace(/^ {0,2}( ?_){3,}[ \t]*$/gm, t)),
        (e = r.converter
          ._dispatch("makehtml.horizontalRule.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.images", function (e, l, h) {
      ...
      function a(e, a, r, t, n, s, i, o) {
        return c(
          ...
          a,
          r,
          (t = P.helper.applyBaseUrl(l.relativePathBaseUrl, t)),
          n,
          s,
          0,
          o
      ...
      function c(e, a, r, t, n, s, i, o) {
        ...
        if (
          ...
          if (
            ...
            P.helper.isUndefined(l[r]))
          )
            return e;
          (t = l[r]),
            P.helper.isUndefined(c[r]) || (o = c[r]),
            P.helper.isUndefined(u[r]) || ((n = u[r].width), (s = u[r].height));
        }
        a = a
          .replace(/"/g, "&quot;")
          .replace(
      ...
      return (
        (e = (e = (e = (e = (e = (e = h.converter
          ._dispatch("makehtml.images.before", e, l, h)
          .getText()).replace(
          /!\[([^\]]*?)] ?(?:\n *)?\[([\s\S]*?)]()()()()()/g,
          c
        )).replace(
    ...
    P.subParser("makehtml.italicsAndBold", function (e, a, r) {
      ...
      return (
        (e = r.converter
          ._dispatch("makehtml.italicsAndBold.before", e, a, r)
          .getText()),
        ...
        (e = r.converter
          ._dispatch("makehtml.italicsAndBold.after", e, a, r)
          .getText())
      );
    }),
    (s = "makehtml.links"),
    P.subParser("makehtml.links", function (e, a, r) {
      return (
        ...
        (e = (e = (e = P.subParser("makehtml.links.ghMentions")(
          e,
          a,
          r
    ...
    P.subParser("makehtml.links.inline", function (e, a, r) {
      ...
      return (
        (e = (e = (e = (e = (e = r.converter
          ._dispatch(t + ".start", e, a, r)
          .getText()).replace(n, l(n, t, a, r, !0))).replace(
          s,
          l(s, t, a, r)
        )).replace(i, l(i, t, a, r))).replace(o, l(o, t, a, r))),
    ...
    P.subParser("makehtml.links.ghMentions", function (e, s, i) {
      ...
      return (
        (e = e.replace(l, function (e, a, r, t, n) {
          if ("\\" === r) return a + t;
          if (!P.helper.isString(s.ghMentionsLink))
            throw new Error("ghMentionsLink option must be a string");
          r = s.ghMentionsLink.replace(/{u}/g, n);
          return (
            a + b(_(l, o + ".captureStart", e, t, null, r, null, s, i), s, i)
          );
        })),
    ...
    P.subParser("makehtml.links.angleBrackets", function (e, t, n) {
      var s = "makehtml.links.angleBrackets",
        i =
          ((e = n.converter._dispatch(s + ".start", e, t, n).getText()),
          /<(((?:https?|ftp):\/\/|www\.)[^'">\s]+)>/gi),
        o =
      ...
      return (
        (e = e.replace(o, function (e, a) {
          ...
          return (
            ...
            t.encodeEmails
              ? ((r = P.helper.encodeEmailAddress(r + a)),
                (a = P.helper.encodeEmailAddress(a)))
              : (r += a),
    ...
    P.subParser("makehtml.links.naked", function (e, u, h) {
      ...
      var m = "makehtml.links.naked",
        d =
          ((e = h.converter._dispatch(m + ".start", e, u, h).getText()),
        ...
        n =
          ((e = e.replace(d, function (e, a, r, t) {
            ...
            return (
              ...
              a +
                b(_(d, m + ".captureStart", e, c, null, r, null, u, h), u, h) +
                n +
                a
            );
          })),
      ...
      return (
        (e = e.replace(n, function (e, a, r) {
          ...
          return (
            ...
            u.encodeEmails
              ? ((t = P.helper.encodeEmailAddress(t + r)),
                (r = P.helper.encodeEmailAddress(r)))
              : (t += r),
    ...
    P.subParser("makehtml.lists", function (e, g, p) {
        ...
        return (
          ...
          (e = (e = e.replace(r, function (e, a, r, t, n, s, i) {
            ...
            if (
              ...
              for (
                var l = (n = (n = (n = P.subParser("makehtml.hashHTMLBlocks")(
                    n,
                    g,
                    p
                  )).replace(/^\n+/g, "")).replace(/\n+$/g, "")).split(
                ...
                0 <= m.search(/¨([KG])(\d+)\1/g)
                  ? c.push(m)
                  : 0 <= m.search(/\S/) &&
                    ((m = (m = P.subParser("makehtml.spanGamut")(
                      m,
                      g,
                      p
                    )).replace(/^([ \t]*)/g, "<p>")),
      ...
      function n(n, s, i) {
        var e,
          o = g.disableForced4SpacesIndentedSublists
            ? /^ ?\d+\.[ \t]/gm
            : /^ {0,3}\d+\.[ \t]/gm,
          l = g.disableForced4SpacesIndentedSublists
            ? /^ ?[*+-][ \t]/gm
            : /^ {0,3}[*+-][ \t]/gm,
          c = "ul" === s ? o : l,
          u = "";
    ...
    P.subParser("makehtml.metadata", function (e, a, t) {
      ...
      return a.metadata
        ? ((e = (e = (e = (e = t.converter
            ._dispatch("makehtml.metadata.before", e, a, t)
            .getText()).replace(
            /^\s*«««+(\S*?)\n([\s\S]+?)\n»»»+\n/,
            function (e, a, r) {
              return n(r), "¨M";
    ...
    P.subParser("makehtml.outdent", function (e, a, r) {
      ...
      return (
        (e = (e = (e = r.converter
          ._dispatch("makehtml.outdent.before", e, a, r)
          .getText()).replace(/^(\t|[ ]{1,4})/gm, "¨0")).replace(/¨0/g, "")),
        (e = r.converter._dispatch("makehtml.outdent.after", e, a, r).getText())
      );
    }),
    P.subParser("makehtml.paragraphs", function (e, a, r) {
      "use strict";
      for (
        var t = (e = (e = (e = r.converter
            ._dispatch("makehtml.paragraphs.before", e, a, r)
            .getText()).replace(/^\n+/g, "")).replace(/\n+$/g, "")).split(
            /\n{2,}/g
          ),
          n = [],
        ...
        var o = t[i];
        0 <= o.search(/¨(K|G)(\d+)\1/g)
          ? n.push(o)
          : 0 <= o.search(/\S/) &&
            ((o = (o = P.subParser("makehtml.spanGamut")(o, a, r)).replace(
              /^([ \t]*)/g,
              "<p>"
            )),
            (o += "</p>"),
        ...
        for (var l = "", c = n[i], u = !1; /¨(K|G)(\d+)\1/.test(c); ) {
          ...
          (l = (l =
            "K" === h
              ? r.gHtmlBlocks[m]
              : u
              ? P.subParser("makehtml.encodeCode")(r.ghCodeBlocks[m].text, a, r)
      ...
      return (
        ...
        r.converter._dispatch("makehtml.paragraphs.after", e, a, r).getText()
      );
    }),
    P.subParser("makehtml.runExtension", function (e, a, r, t) {
      ...
      return (
        e.filter
          ? (a = e.filter(a, t.converter, r))
          : e.regex &&
            ((t = e.regex) instanceof RegExp || (t = new RegExp(t, "g")),
            (a = a.replace(t, e.replace))),
        a
      );
    }),
    P.subParser("makehtml.spanGamut", function (e, a, r) {
      ...
      return (
        ...
        (e = P.subParser("makehtml.escapeSpecialCharsWithinTagAttributes")(
          e,
          a,
          r
        )),
        ...
        (e = r.converter
          ._dispatch("smakehtml.links.before", e, a, r)
          .getText()),
        ...
        a.simpleLineBreaks
          ...
          : (e = e.replace(/  +\n/g, "<br />\n")),
        (e = r.converter
          ._dispatch("makehtml.spanGamut.after", e, a, r)
          .getText())
      );
    }),
    P.subParser("makehtml.strikethrough", function (e, a, r) {
      ...
      return (
        a.strikethrough &&
          ((e = (e = r.converter
            ._dispatch("makehtml.strikethrough.before", e, a, r)
            .getText()).replace(/(?:~){2}([\s\S]+?)(?:~){2}/g, function (e, a) {
            return "<del>" + a + "</del>";
          })),
          (e = r.converter
            ._dispatch("makehtml.strikethrough.after", e, a, r)
            .getText())),
        e
      );
    }),
      ...
      function e(e, a, r, t, n, s, i) {
        return (
          ...
          o.toLowerCase().split(a).length - 1 < 2
            ? e
            : (r.match(/^data:.+?\/.+?;base64,/)
                ? (c.gUrls[a] = r.replace(/\s/g, ""))
                : ((r = P.helper.applyBaseUrl(l.relativePathBaseUrl, r)),
                  (c.gUrls[a] = P.subParser("makehtml.encodeAmpsAndAngles")(
                    r,
                    l,
                    c
                  ))),
              s
                ? s + i
                : (i && (c.gTitles[a] = i.replace(/"|'/g, "&quot;")),
                  l.parseImgDimensions &&
                    t &&
                    n &&
                    (c.gDimensions[a] = { width: t, height: n }),
                  ""))
        );
      }
    ...
    P.subParser("makehtml.tables", function (e, y, x) {
      ...
      function a(e) {
        for (var a = e.split("\n"), r = 0; r < a.length; ++r)
          /^ {0,3}\|/.test(a[r]) && (a[r] = a[r].replace(/^ {0,3}\|/, "")),
            /\|[ \t]*$/.test(a[r]) && (a[r] = a[r].replace(/\|[ \t]*$/, "")),
            (a[r] = P.subParser("makehtml.codeSpans")(a[r], y, x));
        var t,
          n,
          s,
          i,
          ...
          P.helper.isUndefined(m[r]) && (m[r] = ""),
            h.push(
              ...
              "<th" +
                ...
                s +
                ">" +
                (n = P.subParser("makehtml.spanGamut")(n, y, x)) +
                "</th>\n")
            );
        for (r = 0; r < u.length; ++r) {
          for (var g = [], p = 0; p < h.length; ++p)
            P.helper.isUndefined(u[r][p]),
              g.push(
                ((o = u[r][p]),
                "<td" +
                  m[p] +
                  ">" +
                  P.subParser("makehtml.spanGamut")(o, y, x) +
                  "</td>\n")
              );
          d.push(g);
        }
      ...
      return (
        (e = (e = (e = (e = x.converter
          ._dispatch("makehtml.tables.before", e, y, x)
          .getText()).replace(
          /\\(\|)/g,
          P.helper.escapeCharactersCallback
        )).replace(
    ...
    P.subParser("makehtml.underline", function (e, a, r) {
      ...
      return a.underline
        ? ((e = r.converter
            ._dispatch("makehtml.underline.before", e, a, r)
            .getText()),
    ...
    P.subParser("makehtml.unescapeSpecialChars", function (e, a, r) {
      ...
      return (
        (e = (e = r.converter
          ._dispatch("makehtml.unescapeSpecialChars.before", e, a, r)
          .getText()).replace(/¨E(\d+)E/g, function (e, a) {
          a = parseInt(a);
          return String.fromCharCode(a);
        })),
        (e = r.converter
          ._dispatch("makehtml.unescapeSpecialChars.after", e, a, r)
          .getText())
      );
    }),
    ...
    P.subParser("makeMarkdown.emphasis", function (e, a) {
      ...
      if (e.hasChildNodes()) {
        r += "*";
        for (var t = e.childNodes, n = t.length, s = 0; s < n; ++s)
          r += P.subParser("makeMarkdown.node")(t[s], a);
        r += "*";
      }
      return r;
    }),
    P.subParser("makeMarkdown.header", function (e, a, r) {
      ...
      var r = new Array(r + 1).join("#"),
        t = "";
      if (e.hasChildNodes())
        for (var t = r + " ", n = e.childNodes, s = n.length, i = 0; i < s; ++i)
          t += P.subParser("makeMarkdown.node")(n[i], a);
      return t;
    }),
    ...
    P.subParser("makeMarkdown.input", function (e, a) {
      ...
      for (
        var r = "",
          t =
            (null !== e.getAttribute("checked") ? (r += "[x]") : (r += "[ ]"),
            e.childNodes),
          n = t.length,
          s = 0;
        s < n;
    ...
    P.subParser("makeMarkdown.links", function (e, a) {
      ...
      if (e.hasChildNodes() && e.hasAttribute("href")) {
        for (var t = e.childNodes, n = t.length, r = "[", s = 0; s < n; ++s)
          r += P.subParser("makeMarkdown.node")(t[s], a);
        (r = (r += "](") + ("<" + e.getAttribute("href") + ">")),
          e.hasAttribute("title") &&
    ...
    P.subParser("makeMarkdown.list", function (e, a, r) {
      ...
      for (
        ...
        void 0 !== n[o].tagName &&
          "li" === n[o].tagName.toLowerCase() &&
          ((t +=
            ("ol" === r ? i.toString() + ". " : "- ") +
            P.subParser("makeMarkdown.listItem")(n[o], a)),
          ++i);
      return t.trim();
    }),
    P.subParser("makeMarkdown.listItem", function (e, a) {
      "use strict";
      for (var r = "", t = e.childNodes, n = t.length, s = 0; s < n; ++s)
        r += P.subParser("makeMarkdown.node")(t[s], a);
      return (
        /\n$/.test(r)
          ? (r = r
    ...
    P.subParser("makeMarkdown.table", function (e, a) {
      ...
      for (i = 0; i < s.length; ++i)
        for (
          var c = t.push([]) - 1, u = s[i].getElementsByTagName("td"), h = 0;
          h < n.length;
          ++h
        ) {
          var m = " ";
          void 0 !== u[h] &&
            (m = P.subParser("makeMarkdown.tableCell")(u[h], a)),
            t[c].push(m);
        }
      var d = 3;
      ...
      for (i = 0; i < t.length; ++i) {
        for (h = 0; h < t[i].length; ++h)
          1 === i
            ? ":" === t[i][h].slice(-1)
              ? (t[i][h] =
                  P.helper.padEnd(t[i][h].slice(0, -1), d - 1, "-") + ":")
              : (t[i][h] = P.helper.padEnd(t[i][h], d, "-"))
            : (t[i][h] = P.helper.padEnd(t[i][h], d));
        r += "| " + t[i].join(" | ") + " |\n";
      }
      return r.trim();
    ...
    P.subParser("makeMarkdown.tableCell", function (e, a) {
      ...
      if (!e.hasChildNodes()) return "";
      for (var t = e.childNodes, n = t.length, s = 0; s < n; ++s)
        r += P.subParser("makeMarkdown.node")(t[s], a, !0);
      return r.trim();
    }),
    P.subParser("makeMarkdown.txt", function (e) {
      ...
      return (
        ...
        (e = (e = (e = (e = (e = (e = (e = (e = (e =
          P.helper.unescapeHTMLEntities(e)).replace(
          /([*_~|`])/g,
          "\\$1"
    ...
    (P.Converter = function (e) {
      ...
      function i(e, a) {
        if (((a = a || null), P.helper.isString(e))) {
          if (((a = e = P.helper.stdExtName(e)), P.extensions[e])) {
            ...
            var r = P.extensions[e],
              t = e;
            if (
              ("function" == typeof r && (r = r(new P.Converter())),
              P.helper.isArray(r) || (r = [r]),
              !(t = p(r, t)).valid)
            )
              throw Error(t.error);
        ...
        for (var s = 0; s < e.length; ++s) {
          ...
          if (e[s].hasOwnProperty("listeners"))
            for (var i in e[s].listeners)
              e[s].listeners.hasOwnProperty(i) && u(i, e[s].listeners[i]);
        }
      }
      function u(e, a) {
        if (!P.helper.isString(e))
      ...
      n.extensions && P.helper.forEach(n.extensions, i),
        ...
        (this.makeHtml = function (a) {
          ...
          return (
            (a = (a = (a = (a = (a = a.replace(/¨/g, "¨T")).replace(
              /\$/g,
              "¨D"
            )).replace(/\r\n/g, "\n")).replace(/\r/g, "\n")).replace(
              /\u00A0/g,
            ...
            n.smartIndentationFix &&
              ((r = (e = a).match(/^\s*/)[0].length),
              (r = new RegExp("^\\s{0," + r + "}", "gm")),
              (a = e.replace(r, ""))),
            (a = "\n\n" + a + "\n\n"),
            (a = (a = P.subParser("makehtml.detab")(a, n, t)).replace(
              /^[ \t]+$/gm,
              ""
            )),
            ...
            var a = P.helper.document.createElement("div"),
              r =
                ((a.innerHTML = e),
                {
                  preList: (function (e) {
                    for (
                      var a = e.querySelectorAll("pre"), r = [], t = 0;
                      t < a.length;
                      ++t
                    )
                      if (
                        1 === a[t].childElementCount &&
                        "code" === a[t].firstChild.tagName.toLowerCase()
                      ) {
                        var n = a[t].firstChild.innerHTML.trim(),
                          s =
                            a[t].firstChild.getAttribute("data-language") || "";
                        if ("" === s)
                          for (
                            var i = a[t].firstChild.className.split(" "), o = 0;
                            o < i.length;
                            ++o
                          ) {
                        ...
                        (n = P.helper.unescapeHTMLEntities(n)),
                          r.push(n),
                          (a[t].outerHTML =
                            '<precode language="' +
                            s +
                        ...
                        r.push(a[t].innerHTML),
                          (a[t].innerHTML = ""),
                          a[t].setAttribute("prenum", t.toString());
                    return r;
                  })(a),
                }),
              t =
        ...
        (this.removeExtension = function (e) {
          ...
          for (var a = 0; a < e.length; ++a) {
            for (var r = e[a], t = 0; t < o.length; ++t)
              o[t] === r && o.splice(t, 1);
